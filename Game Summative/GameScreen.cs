...
namespace Game_Summative
{
	public partial class GameScreen : UserControl
	{
		...
		//On this function I just removed some redundancy.
		...
		private void GameScreen_Paint(object sender, PaintEventArgs e)
		{
			...
			foreach (Grid g in grid)
			{
				if (g.trapped == true) // Traps
				{
					...
					{
						Image lichIdle = null, lichActive = null;
						switch (currentLevel)
						{
							case 30:
								break;
							...
							case 32:
								lichIdle = lichTwo1;
								lichActive = lichTwo2; break;
							case 33:
								lichIdle = lichThree1;
								lichActive = lichThree2; break;
							case 34:
								lichIdle = lichThree1;
								lichActive = lichThree2;
								break;
						}
						if (idleMode >= 1)
						{
							e.Graphics.DrawImage(lichIdle, g.screenX, g.screenY, g.squareSize, g.squareSize);
						}
						else
						{
							e.Graphics.DrawImage(lichActive, g.screenX, g.screenY, g.squareSize, g.squareSize);
						}
					}
				}
			...
			foreach (Enemy n in enemy) // Enemy sprites
			{
				...
				Image enemyPassive = null, enemyActive = null;
				switch (currentLevel)
				{
					case 1:
						enemyPassive = enemyOne1;
						enemyActive = enemyOne2;
						break;
					case 2:
						enemyPassive = enemyTwo1;
						enemyActive = enemyTwo2;
						break;
					case 3:
						enemyPassive = enemyThree1;
						enemyActive = enemyThree2;
						break;
					case 4:
						enemyPassive = enemyFour1;
						enemyActive = enemyFour2;
						break;
					case 5:
						enemyPassive = enemyFive1;
						enemyActive = enemyFive2;
						break;
				...
				if (idleMode >= 1)
				{
					e.Graphics.DrawImage(enemyPassive, n.x, n.y, n.enemySize, n.enemySize);
				}
				//Frame 2 case
				else
				{
					e.Graphics.DrawImage(enemyActive, n.x, n.y, n.enemySize, n.enemySize);
				}
			}
